...
<script src="js/menu/fatherMenu.js"></script>
<script type="text/javascript">
    var url = "${pageContext.request.contextPath}/fatherMenu";
    var method;
    ...
    */
    function deleteFatherMenu() {
        ...
        for ( var i = 0; i < selectedRows.length; i++) {
            var id = selectedRows[i].fatherMenuId;
            if (id == 1) {
    ...
    function openUserModifyDialog() {
        ...
        $("#fatherMenuId").val(row.fatherMenuId);
        method = "PUT";
    }
...
<body style="margin:1px;">
    ...
    <div id="tb">
        <div>
            <a href="javascript:openUserAddDialog()" class="easyui-linkbutton"
                ...
                href="javascript:deleteFatherMenu()" class="easyui-linkbutton"
    ...
    <div id="dlg" class="easyui-dialog"
        ...
        <input type="hidden" id="fatherMenuId" value="0">
    ...
    <div id="dlg-buttons">
        <a href="javascript:saveFatherMenu()" class="easyui-linkbutton"
